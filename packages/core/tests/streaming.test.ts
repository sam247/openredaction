...
} from "../src/streaming/StreamingDetector";
...
describe("Streaming API", () => {
  ...
  describe("Chunk processing", () => {
    ...
    it("should provide correct byte offsets", async () => {
      ...
      const text =
        "a".repeat(100) + "Email: user@business.co.uk" + "b".repeat(100);
      const chunks: any[] = [];
    ...
    it("should redact chunks progressively", async () => {
      ...
      const text =
        "Email: user@company.com and another email: admin@company.com";
      const chunks: any[] = [];
  ...
  describe("Complete processing", () => {
    ...
    it("should produce same result as non-streaming for small text", async () => {
      ...
      expect(streamResult.detections.length).toBe(
        normalResult.detections.length,
      );
  ...
  describe("Edge cases", () => {
    ...
    it("should handle very long documents", async () => {
      ...
      const prefix = "This is a very long document with lots of text. ".repeat(
        20,
      );
