...
export const FIJI_NATIONAL_ID: PIIPattern = {
  ...
  regex:
    /\b(?:FIJI|FJ)[-\s]?(?:ID|NATIONAL\s?ID)[-\s]?[:#]?\s*([A-Z0-9]{8,10})\b/gi,
...
export const PNG_NATIONAL_ID: PIIPattern = {
  ...
  regex:
    /\b(?:PNG|PAPUA)[-\s]?(?:ID|NATIONAL\s?ID)[-\s]?[:#]?\s*([A-Z0-9]{8,12})\b/gi,
...
export const TONGA_NATIONAL_ID: PIIPattern = {
  ...
  regex:
    /\b(?:TONGA|TO)[-\s]?(?:ID|NATIONAL\s?ID)[-\s]?[:#]?\s*([A-Z0-9]{8,10})\b/gi,
