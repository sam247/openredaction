...
export const SOLANA_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /solana|sol\b|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    ...
    const rejectKeywords =
      /example|test|sample|demo|fake|dummy|placeholder|version|release/i;
...
export const POLKADOT_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /polkadot|dot\b|crypto|wallet|blockchain|substrate|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
...
export const AVALANCHE_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /avalanche|avax\b|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
...
export const COSMOS_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /cosmos|atom\b|crypto|wallet|blockchain|ibc|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
...
export const ALGORAND_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /algorand|algo\b|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
...
export const TEZOS_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /tezos|xtz\b|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
...
export const POLYGON_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const polygonKeywords =
      /polygon|matic\b|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    ...
    if (
      /ethereum|eth\b|ether/i.test(context) &&
      !/polygon|matic/i.test(context)
    ) {
      return false;
    }
...
export const BINANCE_CHAIN_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const binanceKeywords =
      /binance|bnb\b|bsc|smart[- ]?chain|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    ...
    if (
      /ethereum|eth\b|ether/i.test(context) &&
      !/binance|bnb|bsc/i.test(context)
    ) {
      return false;
    }
...
export const NEAR_ADDRESS: PIIPattern = {
  ...
  validator: (value: string, context: string) => {
    ...
    const cryptoKeywords =
      /near|protocol|crypto|wallet|blockchain|address|send|receive|transaction|transfer/i;
    if (!cryptoKeywords.test(context)) {
      return false;
    }
