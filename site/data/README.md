...
`wall-of-love.json` is the **curated** list shown on [openredaction.com/community](/community) and the homepage.

## How entries get here

1. Someone posts in GitHub Discussions: [**Who's using Open Redaction?**](https://github.com/sam247/openredaction/discussions/28) (or the current pinned thread).
