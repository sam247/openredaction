...
const ecosystemCarouselItems: EcosystemCarouselItem[] = [
  ...
  {
    name: "Constellation",
    iconSrc: "/logo_repo/logos_icons/Constellation.svg",
  },
  {
    name: "Euphoria",
    iconSrc: "/logo_repo/logos_icons/Euphoria.svg",
    wordmarkSrc: "/logo_repo/logos/Euphoria.svg",
  },
  { name: "Cubekit", iconSrc: "/logo_repo/logos_icons/Cubekit.svg" },
  {
    name: "Segment",
    iconSrc: "/logo_repo/logos_icons/Segment.svg",
    wordmarkSrc: "/logo_repo/logos/Segment.svg",
  },
  {
    name: "Luminary",
    iconSrc: "/logo_repo/logos_icons/Luminary.svg",
    wordmarkSrc: "/logo_repo/logos/Luminary.svg",
  },
  ...
  {
    name: "Kintsugi",
    iconSrc: "/logo_repo/logos_icons/Kintsugi.svg",
    wordmarkSrc: "/logo_repo/logos/Kintsugi.svg",
  },
  { name: "Hexsmith", iconSrc: "/logo_repo/logos_icons/Hexsmith.svg" },
  { name: "Elasticware", iconSrc: "/logo_repo/logos_icons/Elasticware.svg" },
  {
    name: "Capsule",
    iconSrc: "/logo_repo/logos_icons/Capsule.svg",
    wordmarkSrc: "/logo_repo/logos/Capsule.svg",
  },
  { name: "FocalPoint", iconSrc: "/logo_repo/logos_icons/FocalPoint.svg" },
  {
    name: "Pagemanage",
    iconSrc: "/logo_repo/logos_icons/Pagemanage.svg",
    wordmarkSrc: "/logo_repo/logos/Pagemanage.svg",
  },
  { name: "Norse Star", iconSrc: "/logo_repo/logos_icons/Norse Star.svg" },
  {
    name: "LaunchSimple",
    iconSrc: "/logo_repo/logos_icons/LaunchSimple.svg",
    wordmarkSrc: "/logo_repo/logos/LaunchSimple.svg",
  },
] as const;
...
function ComingSoonLogo({
  ...
  logo: "openai" | "express" | "logs" | "webhook";
}) {
  const logoMap = {
    openai: "/chatgpt.png",
    express: "/js.png",
              ...
              <div className="mt-4 grid gap-3">
                <div className="rounded-lg border border-gray-800 bg-black/80 p-4">
                  <div className="font-mono text-sm text-gray-200 leading-6">
                    support note: customer said email me at john@email.com
                    before 5, card ends 4242
                  </div>
                </div>
                <div className="rounded-lg border border-gray-800 bg-black p-4">
                  <div className="font-mono text-sm text-green-400 leading-6">
                    support note: customer said email me at [REDACTED] before 5,
                    card ends [REDACTED]
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {featureItems.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="rounded-xl border border-gray-900 bg-gray-950/60 p-4"
                  >
...
// helpdesk reply: reach me at [REDACTED], mobile [REDACTED]`}
            ...
            <div className="min-w-0 rounded-2xl border border-gray-800 bg-gray-950 p-5 sm:p-6">
              ...
              <p className="mt-2 text-sm text-gray-400">
                Install it, import it, and redact before you send anything to an
                API.
              </p>
          ...
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] items-start">
            <div className="min-w-0">
              ...
              <p className="mt-3 text-gray-400 max-w-xl">
                Keep pasted emails, callback numbers, card details, and account
                references out of prompts and logs.
              </p>
            </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <div className="mt-2 rounded-lg border border-gray-800 bg-black p-4 text-sm text-gray-200">
                    customer pasted: jane.doe@company.com, call back on
                    555-219-0081 before 4
                  </div>
                </div>
                <div>
                  <div className="text-xs uppercase tracking-[0.18em] text-gray-500">
                  ...
                  <div className="mt-2 rounded-lg border border-gray-800 bg-black p-4 text-sm text-green-400">
                    customer pasted: [REDACTED], call back on [REDACTED] before
                    4
                  </div>
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32">
          <div className="border-t border-gray-900 pt-14 text-center">
            <p className="mx-auto max-w-3xl text-2xl sm:text-3xl font-semibold tracking-tight text-white">
              &ldquo;OpenRedaction gave us a practical, inspectable first layer
              for masking obvious PII before prompts and logs.&rdquo;
            </p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32">
          <div className="rounded-2xl border border-gray-800 bg-gray-950 p-5 sm:p-6 lg:p-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-sm text-gray-400">
                A simple Node.js option if you want local redaction, plus common
                managed and Python-based alternatives.
              </p>
            </div>
            ...
            <div className="mt-8 overflow-x-auto rounded-2xl border border-gray-800 bg-black/40">
              <table className="min-w-[820px] w-full text-left">
                <thead className="bg-gray-950/80">
                  <tr>
                    <th className="px-4 py-3 text-xs uppercase tracking-[0.18em] text-gray-500">
                      Tool
                    </th>
                    <th className="px-4 py-3 text-xs uppercase tracking-[0.18em] text-gray-500">
                      Type
                ...
                <tbody>
                  {comparisonCards.map((card, index) => (
                    <tr
                      key={card.name}
                      className={
                        index === 0 ? "bg-gray-950/50" : "bg-transparent"
                      }
                    >
                      <td className="px-4 py-4 border-t border-gray-900 text-sm font-medium text-white">
                        {card.name}
                      </td>
                      <td className="px-4 py-4 border-t border-gray-900 text-sm text-gray-300">
                        {card.type}
                      </td>
                      <td className="px-4 py-4 border-t border-gray-900 text-sm text-gray-300">
                        {card.runtime}
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              <div className="max-w-2xl">
                ...
                <p className="mt-3 text-gray-300">
                  Install it, drop it into your request path, and clean prompts,
                  logs, or stored text before it leaves your system.
                </p>
