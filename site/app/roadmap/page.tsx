...
function RoadmapList({ title, items }: { title: string; items: readonly string[] }) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              OpenRedaction is open source and community-driven. This page is a snapshot of{' '}
              <strong className="text-white font-medium">current direction</strong> — not a contract on
              dates or scope. Priorities shift with feedback, contributions, and real-world use.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <RoadmapList title="Recently shipped" items={roadmapRecentlyShipped} />
          </div>
          ...
          <div className="max-w-2xl rounded-lg border border-gray-800 bg-gray-950/50 p-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              We are exploring a plugin to help redact sensitive data in form submissions, comments, and
          ...
          <p className="text-center text-gray-500 text-sm mt-12">
            Library and docs:{' '}
            <Link href="/docs" className="text-gray-400 hover:text-white underline">
              Documentation
            </Link>
            {' · '}
            <a
