...
export default function Playground() {
  ...
  const handleRedact = async () => {
    ...
    if (inputText.length > MAX_INPUT_REGEX) {
      setError(`Text too long — please reduce input to ${MAX_INPUT_REGEX.toLocaleString()} characters. Current: ${inputText.length.toLocaleString()} characters.`);
            ...
            <div className="flex-1 p-4 flex flex-col">
              ...
              <div className="mt-2 flex justify-between items-center text-xs">
                <span className={`${inputText.length > MAX_INPUT_REGEX ? 'text-red-400' : 'text-gray-500'}`}>
                  {inputText.length.toLocaleString()} / {MAX_INPUT_REGEX.toLocaleString()} characters
                </span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300 text-sm">
                  ...
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
                    <span>Detection uses the open-source library with 500+ regex patterns</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300 text-sm">
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
                    <span><strong>Demo limit:</strong> {MAX_INPUT_REGEX.toLocaleString()} characters per request in this playground</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
                    <span>No data is logged or stored — all processing runs in your browser</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
