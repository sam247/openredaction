...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Contact OpenRedaction for enterprise support, custom deployments, SLAs, and self-hosted PII redaction at scale.',
  path: '/pricing',
});
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-300">
              OpenRedaction is open source and self-hostable. For custom deployments, SLAs, or dedicated support at scale, get in touch.
            </p>
          </div>
            ...
            <div className="bg-gray-900 rounded-lg p-8 border border-gray-800">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">Enterprise support and custom deployment guidance</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-green-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-gray-300">SLAs and dedicated support for high-volume or regulated environments</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-green-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-gray-300">Integration and architecture advice for self-hosted PII redaction</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-green-400 mr-3 mt-1 flex-shrink-0" size={20} />
                  <span className="text-gray-300">Training and compliance best practices</span>
                </li>
              </ul>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-gray-400 text-sm">
              The OpenRedaction library is free and open source. Use it locally or self-host with no fees. Enterprise support is optional and tailored to your needs.
            </p>
          </div>
        </div>
      </main>
