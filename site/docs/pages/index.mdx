---
title: 'OpenRedaction Docs: Install, API & Redaction Guides'
description: 'Install OpenRedaction, run your first redaction, and use the API — local Node.js PII detection with 500+ regex patterns. No external calls.'
---
